...
void common_fill_pcb_pad (hidGC gc, PadType *pad, bool clear, bool mask, bool paste);
void common_thindraw_pcb_pad (hidGC gc, PadType *pad, bool clear, bool mask, bool paste);
